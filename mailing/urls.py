...
from mailing.views import (
    ...
    MailingDetailView,
    MailingUpdateView,
    MailingDeleteView, MailingAttemptListView, MailingAttemptDetailView,
)
...
urlpatterns = [
    ...
    path("mailingattempt/<int:pk>/", MailingAttemptDetailView.as_view(), name="mailing_attempt_detail"),
]
